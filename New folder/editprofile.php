...
<html>
    ...
    <div class="header">
        ...
        <h1 class="waitingforconnection1">
          ...
          <marquee class="waitingforconnection2" scrollamount="8" behavior="slide" onMouseOver="this.stop();" onMouseOut="this.start();"><font size="6" color="#000000"><center><br/>EDIT PROFILE</center></font></marquee>
          ...
          <div class="contentpanneld">
            ...
            <table>
                ...
                <tr class=sizeb>
                    <td><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;10th MARKS : </td>
                    <td><br/><input type="text" name="10thmarks" style="border-radius:7px; border:2px solid #9966CC;" 
                               value="<?php echo $rws['13']?>" /></td>
                </tr>
                <tr class=sizeb>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;12th MARKS</td>
                    <td><input type="text" name="12thmarks" style="border-radius:7px; border:2px solid #9966CC;" 
                               value="<?php echo $rws['14']?>" /></td>
                </tr>
                <tr class=sizeb>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;COLLEGE NAME : </td>
                    <td><input type="text" name="college" style="border-radius:7px; border:2px solid #9966CC;" 
                               value="<?php echo $rws['15']?>" /></td>
                </tr>
                <tr class=sizeb>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;CURRENT SEMESTER : </td>
                    <td><input type="text" name="currentsem" style="border-radius:7px; border:2px solid #9966CC;" 
                               value="<?php echo $rws['16']?>"/></td>
                </tr>
                <tr class="sizeb">
                    <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;
                       <input type="submit" name="submitbtn" value="UPDATE" style="border-radius:7px; border:3px solid #9966CC;"/></td>
                </tr>
                </div>
            </form>
          <div>
                <form action="changepic.php" method="POST" enctype="multipart/form-data">
                    <table>
                        <tr class="sizeb">
                            ...
                            <td><br/><input type="file" name="mypic" style="border-radius:7px; border:2px solid #9966CC;" value="Change Pic"/></td>
                            <td><br/>&nbsp;&nbsp;&nbsp;<input type="submit" name="changepic" style="border-radius:7px; border:2px solid #9966CC;"/></td>
                        </tr>
                    </table>
                </form>
            </div>
